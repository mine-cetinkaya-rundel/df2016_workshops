...
```{r eval = FALSE}
plot(y = movies$audience_score, x = movies$critics_score, col = movies$title_type)
...
legend("topleft", levels(movies$title_type), col = c(1,2,3), lty = 1)
```
